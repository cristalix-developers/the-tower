...
enum class MobType(
    ...
    SKELETON( 3.0, 1.0, 36.0,9.0, 0.02f,3..5, false, true),
    ...
    WITHER_SKELETON(15.0, 6.0, 8.0,5.0,0.020f,5..5, true, false),
    ZOMBIE_HORSE(25.0, 12.0, 8.0,7.0,0.020f,10..10, true, false),
