...
enum class StartingKit(
    ...
    STARTER_KIT("Стартовый набор", "Постоянное увеличение всех заработанных монет в 2 раза\nи 150 Самоцветов", 249, 150),
    EPIC_KIT("Эпический набор", "Постоянное увеличение всех заработанных монет в 4 раза\nи 750 Самоцветов", 399, 750),
    ;
